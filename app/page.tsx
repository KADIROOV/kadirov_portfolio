...
import { Download, ExternalLink, Github, Mail, Send, Code, Database, Globe, MessageCirclePlus } from "lucide-react"
...
const translations = {
  en: {
    ...
    sendMessageDesc: "I'd love to hear about your project. Let's discuss how we can work together.",
    yourName: "Your Name",
    ...
    availableDesc: "I'm currently available for freelance projects and frontend development opportunities.",
  ...
  ru: {
    ...
    sendMessageDesc: "Я хотел бы услышать о вашем проекте. Давайте обсудим, как мы можем работать вместе.",
    yourName: "Ваше Имя",
    yourEmail: "Ваш Email",
    ...
    availableDesc: "В настоящее время я доступен для фриланс проектов и frontend разработки.",
  ...
  uz: {
    ...
    sendMessageDesc: "Loyihangiz haqida eshitishni istardim. Qanday hamkorlik qilishimizni muhokama qilaylik.",
    yourName: "Ismingiz",
    ...
    availableDesc: "Hozirda frilanser loyihalari va frontend dasturlash imkoniyatlari uchun mavjudman.",
    footer: "© 2025 Akmaljon Kadirov. Next.js va Tailwind CSS bilan yaratilgan.",
  },
}
...
export default function Portfolio() {
  ...
  const skills = {
    frontend: ["HTML5", "CSS3", "JavaScript", "TypeScript", "Responsive Design", "CSS Grid", "Flexbox"],
    frameworks: ["React", "Next.js", "Tailwind CSS", "Redux Toolkit", "React-Router-DOM", "Sass/SCSS"],
  ...
  const projects = [
    ...
    },
    {
      ...
      description:
        "Sodda va tezkor Counter ilova. Qiymatni oshirish, kamaytirish va qayta nolga tushirish funksiyalari mavjud. React va Tailwind CSS yordamida yaratilgan.",
    ...
    },
    {
      ...
      description:
        "Designo uchun zamonaviy landing page. Mobile, tablet va desktop qurilmalarga moslashtirilgan responsive dizayn. HTML va CSS yordamida ishlab chiqilgan.",
      technologies: ["React", "Chart.js", "CSS Grid"],
      github: "https://github.com/KADIROOV/2M-12L-exam",
      demo: "https://2m-exam.vercel.app/",
    },
  ]
...
<div className="container mx-auto px-4 py-4 flex justify-between items-center">
  <div className="flex items-center space-x-2">
    <div className="relative">
      <div className="w-8 h-8 border-2 border-foreground rounded-sm flex items-center justify-center">
        <span className="text-sm font-bold text-foreground">A</span>
      </div>
      <div className="absolute -bottom-1 -right-1 w-4 h-4 bg-foreground rounded-sm flex items-center justify-center">
        <span className="text-xs font-bold text-background">K</span>
      </div>
    </div>
    <span className="text-lg font-semibold text-foreground tracking-wide">Kadirov</span>
  </div>
    ...
    <Card className="bg-background/60 backdrop-blur-sm border-gray-900 dark:border-gray-100 shadow-xl">
      <CardContent className="p-8 md:p-12 flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
        <div className="flex-shrink-0">
          <div className="w-48 h-48 lg:w-56 lg:h-56 rounded-full overflow-hidden border-4 border-gray-200 dark:border-gray-800 shadow-lg">
            <img
              src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/photo_2025-08-20_14-07-43.jpg-tov86CWMQOpdDbDBrcQgiBZUjxeuqa.jpeg"
              alt="Akmaljon Kadirov - Frontend Developer"
              className="w-full h-full object-cover object-center filter grayscale scale-125"
            />
          </div>
        </div>
        <div className="flex-1 text-center lg:text-left">
          <h1 className="text-4xl md:text-6xl font-bold mb-4 text-balance dark:text-white">{t.name}</h1>
          <h2 className="text-xl md:text-2xl text-muted-foreground mb-6">{t.title}</h2>
  ...
  >
    ...
    <Card className="hover:shadow-xl transition-all duration-300 bg-background border-gray-900 dark:border-gray-100">
      <CardContent className="p-8">
        ...
        <p className="text-lg leading-relaxed text-center text-muted-foreground">{t.aboutDesc}</p>
      </CardContent>
    </Card>
  </div>
</div>
...
<div className="container mx-auto max-w-6xl relative z-10">
  ...
  >
    <h2 className="text-3xl font-bold mb-12 text-center">{t.skillsTitle}</h2>
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
      <Card className="hover:shadow-xl hover:-translate-y-2 transition-all duration-300 bg-background border-gray-900 dark:border-gray-100 h-full">
        <CardHeader className="text-center pb-4">
          ...
          <CardTitle className="text-foreground text-lg">{t.frontend}</CardTitle>
        </CardHeader>
      ...
      <Card className="hover:shadow-xl hover:-translate-y-2 transition-all duration-300 bg-background border-gray-900 dark:border-gray-100 h-full">
        <CardHeader className="text-center pb-4">
          ...
          <CardTitle className="text-foreground text-lg">{t.frameworks}</CardTitle>
        </CardHeader>
        <CardContent className="pt-0">
          <div className="flex flex-wrap gap-2 justify-center">
      ...
      <Card className="hover:shadow-xl hover:-translate-y-2 transition-all duration-300 bg-background border-gray-900 dark:border-gray-100 h-full sm:col-span-2 lg:col-span-1">
        <CardHeader className="text-center pb-4">
          ...
          <CardTitle className="text-foreground text-lg">{t.tools}</CardTitle>
        </CardHeader>
        <CardContent className="pt-0">
          <div className="flex flex-wrap gap-2 justify-center">
...
<div className="container mx-auto max-w-6xl relative z-10">
  ...
  >
    <h2 className="text-3xl font-bold mb-12 text-center">{t.featuredProjects}</h2>
      ...
      <Card className="hover:shadow-xl transition-all duration-300 bg-background/90 backdrop-blur-sm border-gray-900 dark:border-gray-100">
        ...
        <CardContent className="space-y-4">
          ...
          <Button
            ...
            onClick={() => alert("Message sent! (This is a demo - in a real app, this would send an email)")}
          >
      ...
      <div className="space-y-6">
          ...
          <CardContent className="p-6">
            ...
            <div className="space-y-3">
              <Button
                ...
                onClick={() => (window.location.href = "mailto:akmaljonqodirov1223@email.com")}
              >
              ...
              <Button
                variant="outline"
                className="w-full justify-start group bg-transparent hover:bg-gray-50 dark:hover:bg-gray-950/50 border-border"
                onClick={() => window.open("https://t.me/kadirov_akmaljon", "_blank")}
              >
              ...
              <Button
                variant="outline"
                className="w-full justify-start group bg-transparent hover:bg-gray-50 dark:hover:bg-gray-950/50 border-border"
                onClick={() => window.open("https://github.com/kadiroov", "_blank")}
              >
        ...
        <Card className="hover:shadow-xl transition-all duration-300 dark:bg-gray-950/20 backdrop-blur-sm border-gray-900 dark:border-gray-100">
          <CardContent className="p-6 text-center">
            ...
            <p className="text-sm text-muted-foreground mb-4">{t.availableDesc}</p>
            <Button
